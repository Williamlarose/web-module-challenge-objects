...
createMenuItem('cookies',3.25,'sweets');
...
*/
  ...
  // let lowRater=[]
  // for(let i = 0; i< reviews.length; i++ )if(reviews[i].name === "Julius"){lowRater.push(reviews[i])
...
*/
  reviews.push({name:'William',rating:5,feedback:'good'});
